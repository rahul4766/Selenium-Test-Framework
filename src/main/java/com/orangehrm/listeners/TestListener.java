...
public class TestListener implements  ITestListener, IAnnotationTransformer{
	...
	public void onTestFailure(ITestResult result) {
		...
		if(!result.getTestClass().getName().toLowerCase().contains("api")) {
			ExtentManager.logFailure(BaseClass.getDriver(), "Test failed!","Test End:" + testName +" - Test Failed");ExtentManager.logFailure(BaseClass.getDriver(), "Test failed!","Test End:" + testName +" - Test Failed");	
		}
